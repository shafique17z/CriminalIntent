...
interface CrimeDao {
    ...
    fun getCrimes(): List<Crime> /** The return type of this query function in this DAO interface reflects
                                 * the type of result the query will return.
                                 */

    //The other to return a single crime matching a given id.
    @Query("SELECT * FROM crime WHERE id = (:id)")
    fun getCrime(id: UUID): Crime? /** The return type of this query function in this DAO interface reflects
                                   * the type of result the query will return.
                                   */
}